...
export default function Header() {
  ...
  return (
    <header className=" sticky top-0 z-40 items-center justify-center border-zinc-300 bg-musk-green backdrop-blur ">
      <div className="min-h-[12vh] mx-auto flex items-center max-w-6xl justify-between px-4 py-3">
        ...
        <nav className="flex text-white items-center gap-5 text-xs sm:text-sm">
